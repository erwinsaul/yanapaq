defmodule YanapaqWeb.Router do
  use YanapaqWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {YanapaqWeb.Layouts, :root}
  ...
  if Application.compile_env(:yanapaq, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: YanapaqWeb.Telemetry
